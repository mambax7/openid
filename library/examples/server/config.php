 ...
 */
set_include_path(get_include_path() . PATH_SEPARATOR . "/home/www/www.sakimura.org/ja/modules/openid/library/examples/server");
 ...
 */
$server_url = "http://www.sakimura.org/op//server.php";
